...
ProductVariationModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([product_variation_entity_1.ProductVariation])],
        controllers: [product_variation_controller_1.ProductVariationsController],
        exports: [product_variation_service_1.ProductVariationService],
        providers: [product_variation_service_1.ProductVariationService],
    })
